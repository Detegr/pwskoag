...
C_GfxEntity::C_GfxEntity() : m_Pos(), m_Model(), m_Scale(1.0f), m_ModelMatrix(glm::mat4(1.0f)) {}
C_GfxEntity::C_GfxEntity(const C_Model& m, float scale) : m_Pos(), m_Model(m), m_Scale(scale), m_ModelMatrix(glm::mat4(1.0f))
{
	M_Scale(scale);
...
C_GfxEntity* C_GfxEntity::M_Create(const C_Model& m, float scale)
{
	C_GfxEntity* e=new C_GfxEntity(m, scale);
